-- Contains filetype-specific options for go files. Loaded in the
-- after/ftplugin/ directory to override the settings in the global
-- filetype plugin (see :help ftplugin-overrule).
